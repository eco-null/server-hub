...
const KEYWORD_RULES = {
  Monitoring:    ['grafana', 'prometheus', 'kuma', 'uptime', 'alertmanager', 'loki', 'zabbix', 'pyroscope', 'sabnzbd-logs', 'kibana', 'observium', 'munin', 'sensu'],
  ...
  Network:       ['pi-hole', 'pihole', 'adguard', 'wireguard', 'openvpn', 'tailscale', 'wg-easy', 'unbound', 'dnsmasq', 'traefik', 'nginx-proxy-manager', 'npmplus', 'cloudflare-tunnel', 'blocky', 'zerotier'],
  Media:         ['jellyfin', 'plex', 'emby', 'navidrome', 'audiobookshelf', 'komga', 'kavita', 'komf', 'sonarr', 'radarr', 'lidarr', 'lidarrhy', 'prowlarr', 'readarr', 'tautulli', 'overseerr', 'ombi', 'bazarr', 'whisperasr', 'focalpoint', 'audiobook', 'immich', 'photo pris', 'photoprism', 'lychee', 'piwigo'],
  ...
  Files:         ['filebrowser', 'duplicati', 'restic-rest-server', 'borg', 'filerun', 'nextcloud-files', 'seafile', 'rutorrent', 'transmission', 'qbittorrent', 'deluge', 'sabnzbd', 'nzbget', 'syncthing', 'minio', 'garage', 'rclone-webui'],
  Dev:           ['gitea', 'gitea-actions', 'forgeo', 'gitlab', 'forgejo', 'gitea', 'git', 'woodpecker', 'drone', 'jenkins', 'teampass', 'hubgit', 'code', 'coder', 'code-server', 'terminal', 'theia', 'kasm', 'docker', 'portainer', 'dockge', 'komodo', 'dokploy', 'kubernetes', 'k9s', 'mkdocs-dev', 'ruffasr', 'cinny-dev'],
